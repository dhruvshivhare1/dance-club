...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <video
        className="hidden md:absolute z-[1] top-24 -translate-y-0 left-1/2 -translate-x-1/2 w-11/12 sm:w-10/12 md:top-1/2 md:left-0 md:-translate-x-0 md:-translate-y-1/2 md:w-3/4 lg:w-2/3"
        src={VIDEO_URL}
        autoPlay
        loop
        muted
      ...
      <div
        ...
        style={{ backgroundColor: 'rgba(0,0,0,0.42)', zIndex: 5 }}
      />
