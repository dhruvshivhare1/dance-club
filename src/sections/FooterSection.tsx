        ...
        <FadeIn delay={0.3} y={40}>
          <div className="mb-16 sm:mb-20 md:mb-28">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
              {[
                'Company Profile (PDF)',
                'Training System Guide (PDF)',
                'Artist Development Brochure (PDF)',
              ].map((item, i) => (
                <FadeIn key={item} delay={0.3 + i * 0.05} y={20}>
                  <a
                    href="#"
                    className="rounded-[20px] sm:rounded-[30px] p-6 sm:p-8 border border-[#D7E2EA]/30 hover:border-[#D7E2EA] transition-all duration-300 group"
                    style={{ background: 'rgba(215, 226, 234, 0.05)' }}
                  >
                    <p
                      className="font-medium text-[#D7E2EA] group-hover:text-white transition-colors"
